...
def parse_opts():
    ...
    parser.add_argument('--center_crop', action='store_true', help='Whether the input image need to be five cropped or not')
    ...
    parser.add_argument('--end_run', default=10, type=int, help='Number of total epochs to run')
